...
def parse_args():
	...
	parser.add_argument("--images", default="/hhd2/home/Code/lzl_gen/instant-ngp/data/nerf/coffee", help="Input path to the images.")
...
if __name__ == "__main__":
	...
	args.video_fps = fps
	root_dir = "/hhd2/home/Code/lzl_gen/nerf_code/images"
	video_name = os.path.basename(args.video_in).split(".")[0]
	args.images = os.path.join(root_dir, video_name)
	if args.video_in != "":
		run_ffmpeg(args)
	if args.run_colmap:
		run_colmap(args)
